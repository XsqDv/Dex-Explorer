	...
	WelcomeMsg = function()
		...
		local function main()
			...
			WelcomeMsg.Init = function()
				...
				create({
					{1,"Frame",{BackgroundTransparency=1,Position=UDim2.new(0,0,0,0),Size=UDim2.new(1,0,1,0),Parent=window.GuiElems.Content}},
					{2,"TextLabel",{FontFace=Font.new("rbxasset://fonts/families/SourceSansPro.json", Enum.FontWeight.Regular, Enum.FontStyle.Normal),Text="Welcome to Dex Agent's Preview Version",TextColor3=Color3.new(1, 1, 1),TextSize=20,Position=UDim2.new(0.5, 0, 0, 21),Parent={1}}},
					{3,"TextLabel",{FontFace=Font.new("rbxasset://fonts/families/SourceSansPro.json", Enum.FontWeight.Regular, Enum.FontStyle.Normal),Text="This is an exclusive edition of Dex made by the SS Director for the Agents!\nThis is the preview version of the Agent's exclusive edition, for the general public to test\nand see a bit of what Agent's are capable of doing on their exclusive edition. A lot of new\nfeatures are integrated, but features like reading ServerScriptService, ServerStorage,\nDataStore and being able to edit DataStore are unavailable.\n\nFeel free to have a exclusive look at the working 3D Viewer!\nA custom viewer built for Dex that previews any model of the game, without having to\nexport the model and explore it on Roblox Studio!\n\nThe Dex 3D Preview has Controls, allowing you to control the view to your liking, making\nit interactive, and making the user completely free to explore it!\nEnjoy this exclusive preview release of the agent's most powerful explorer to ever exist\non Roblox, better than the Syn V3 Explorer!\n\nUpdates may be done to the preview, stay tuned on our discord!\nhttps://discord.gg/jnXFq2VBgU",TextColor3=Color3.new(1, 1, 1),TextSize=14,Position=UDim2.new(0.5, 0, 0, 154),Parent={1}}}
				})
			end
...
Main = (function()
	...
	Main.CreateIntro = function(initStatus) -- TODO: Must theme and show errors
		local gui = create({
			...
			{6,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Desc",Parent={3},Position=UDim2.new(0,-230,0,60),Size=UDim2.new(0,180,0,25),Text="Agent Edition (Preview)",TextColor3=Color3.new(1,1,1),TextSize=20,TextTransparency=1,}},
